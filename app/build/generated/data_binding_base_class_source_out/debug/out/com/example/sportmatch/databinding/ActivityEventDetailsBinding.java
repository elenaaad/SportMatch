...
public final class ActivityEventDetailsBinding implements ViewBinding {
  ...
  private ActivityEventDetailsBinding(@NonNull RelativeLayout rootView,
  ...
  public static ActivityEventDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEventDetailsBinding((RelativeLayout) rootView, bottomNavigationView,
          detailsBtnEdit, detailsBtnMap, detailsBtnParticipate, detailsDate, detailsDateInput,
